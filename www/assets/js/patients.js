function patients() {
    ...
    cell.innerText = "Name"; cell.style.fontWeight="bold"
    
    var cell= tr.insertCell(1);
    cell.innerText = "Phone"; cell.style.fontWeight="bold"

    var cell= tr.insertCell(2);
    cell.innerText = "Email"; cell.style.fontWeight="bold"

    var cell= tr.insertCell(3);
    cell.innerText = "Date"; cell.style.fontWeight="bold"
